...
class ArucoDetector(Node):
    def __init__(self):
        ...
        # Set target camera frame dimensions
        self.target_width = 1280
        self.target_height = 800
        self.popup_width = 1280
        self.popup_height = 800
    ...
    def image_callback(self, msg):
        ...
        #     crop_start = (new_width - self.target_width) // 2
        #     frame = frame[:, crop_start:crop_start + self.target_width]
        # else:
        #     new_height = int(self.target_width / aspect_ratio)
        #     frame = cv2.resize(frame, (self.target_width, new_height))
        #     crop_start = (new_height - self.target_height) // 2
        #     frame = frame[crop_start:crop_start + self.target_height, :]
        ...
        popup_frame = cv2.resize(annotated_frame, (1280,800))
